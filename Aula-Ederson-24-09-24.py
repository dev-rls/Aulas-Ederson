#Faça um programa que receba uma uma temperatura e transforme de Fahrenheit para Celsius. A formula de conversão de Fahrenheit para Celsius é a seguinte: C= (5/9)*(F-32)
...
#Faça um programa que leia um valor em reais e calcule o valor equivalente em dólares. O usuário deve informar, além de valor em reais da compra, o valor da cotação do dólar.
...
#Faça um algoritmo em linguagem Python que o nome, idade, sexo, e receba duas notas e cacule a média aritimética e mostre o resultado.
...
#Crie uma programa que receba três valores do usuário. Imprima a soma dos dois primeiros multiplicada pelo terceiro.
...
# Tal cadastro solicitará os seguintes dados:(nome, cpf, rg, data do nmascimento, sexo, peso, tipo sanguineo, renda, endereço, telefone, cidade e estado)
